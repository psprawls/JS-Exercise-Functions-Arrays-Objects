...
*/
function makeSmartPerson(nombre) {
  const result = {
      name: nombre,
      sum: function(a,b){
          return a+b;
...
function getLastCarInfo(inventory) {
  return 'The car is a '+inventory[inventory.length-1].car_make+' '+inventory[inventory.length-1].car_model
}
...
function getCarInfoById(inventory, id) {
    return 'The car is a '+inventory[id-1].car_make+' '+inventory[id-1].car_model
}
...
function sortCarInventory(inventory) {
  return inventory.sort(function(a,b) {
      var a1=a.car_model, b1=b.car_model;
      if (a1==b1) return 0;
      return (a1>b1) ? 1 : -1;
  })
}
...
function getOlderCars(inventory, year) {
    ...
    for (var i=0; i<inventory.length; i++)
        ...
        olderCars1[i]=inventory[i]
        else olderCars1[i]=null
    let olderCars2 = olderCars1.filter(function (el) {
        return el != null;
        });
    return olderCars2
}
...
function getGermanCars(inventory) {
    ...
    for (var i=0; i<inventory.length; i++)
        ...
        germanCars1[i]=inventory[i]
        else germanCars1[i]=null
    let germanCars2 = germanCars1.filter(function (el) {
        return el != null;
        });
    return germanCars2
}
